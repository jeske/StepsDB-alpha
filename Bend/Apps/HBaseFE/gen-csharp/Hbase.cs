    ...
    public void Write(TProtocol oprot) {
      ...
      if (Mutations != null && __isset.mutations) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (Mutation _iter65 in Mutations)
          {
            _iter65.Write(oprot);
            oprot.WriteListEnd();
          }
  ...
  public partial class mutateRowTs_args : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  Mutation _elem68 = new Mutation();
                  _elem68 = new Mutation();
                  _elem68.Read(iprot);
                  Mutations.Add(_elem68);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Mutations != null && __isset.mutations) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.Struct, Mutations.Count));
          foreach (Mutation _iter69 in Mutations)
          {
            _iter69.Write(oprot);
            oprot.WriteListEnd();
          }
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  BatchMutation _elem72 = new BatchMutation();
                  _elem72 = new BatchMutation();
                  _elem72.Read(iprot);
                  RowBatches.Add(_elem72);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (RowBatches != null && __isset.rowBatches) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (BatchMutation _iter73 in RowBatches)
          {
            _iter73.Write(oprot);
            oprot.WriteListEnd();
          }
  ...
  public partial class mutateRowsTs_args : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  BatchMutation _elem76 = new BatchMutation();
                  _elem76 = new BatchMutation();
                  _elem76.Read(iprot);
                  RowBatches.Add(_elem76);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (RowBatches != null && __isset.rowBatches) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.Struct, RowBatches.Count));
          foreach (BatchMutation _iter77 in RowBatches)
          {
            _iter77.Write(oprot);
            oprot.WriteListEnd();
          }
  ...
  public partial class scannerOpenWithPrefix_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter89 in Columns)
          {
  ...
  public partial class scannerOpenTs_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Columns != null && __isset.columns) {
        ...
        {
          oprot.WriteListBegin(new TList(TType.String, Columns.Count));
          foreach (byte[] _iter93 in Columns)
          {
